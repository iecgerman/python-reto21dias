...
print(myTaskManager.printTasks()) # {'comprar leche': {'compras', 'urgente'}, 'sacar al perro': {'mascotas'}, 'hacer ejercicio': {'salud'}}
...
print(myTaskManager.printTasks()) # {'comprar leche': {'compras', 'urgente', 'lacteos'}, 'sacar al perro': {'mascotas'}, 'hacer ejercicio': {'salud'}}
